...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">
        <img src="{{ asset('images/carousel/logo.png') }}" width="30" height="30" class="d-inline-block align-top" alt="">
        AltaFacha
    </a>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="max-width: 1280px; margin: auto;">
    ...
    <div class="carousel-inner" style="max-height: 600px;">
        <div class="carousel-item active">
            <img src="{{ asset('images/carousel/imagen4.jpg') }}" class="d-block w-100" alt="Imagen 1">
            <div class="carousel-caption d-none d-md-block">
                <!-- Aquí puedes agregar texto descriptivo si lo deseas -->
            </div>
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/carousel/imagen2.jpg') }}" class="d-block w-100" alt="Imagen 2">
            <div class="carousel-caption d-none d-md-block">
                <!-- Aquí puedes agregar texto descriptivo si lo deseas -->
            </div>
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/carousel/imagen3.jpg') }}" class="d-block w-100" alt="Imagen 3">
            <div class="carousel-caption d-none d-md-block">
                <!-- Aquí puedes agregar texto descriptivo si lo deseas -->
            </div>
        </div>
        <div class="carousel-item">
            <img src="{{ asset('images/carousel/imagen5.jpg') }}" class="d-block w-100" alt="Imagen 4">
            <div class="carousel-caption d-none d-md-block">
                <!-- Aquí puedes agregar texto descriptivo si lo deseas -->
            </div>
        </div>
...
<div class="container mt-5">
    ...
    @foreach ($groupedProducts as $categoryId => $products)
        ...
        @endphp
        <div class="mb-4" id="{{ strtolower(str_replace(' ', '-', $categoryName)) }}">
            <h2 class="text-center mb-4">{{ $categoryName }}</h2>
            <div class="row">
                @foreach ($products as $product)
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="{{ $product->imagen }}" class="card-img-top producto-img" alt="Imagen del Producto">
                        <div class="card-body">
